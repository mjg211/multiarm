#' Design a multi-stage drop-the-losers multi-arm clinical trial for a Poisson
#' distributed primary outcome
#'
#' \code{des_dtl_pois()} determines multi-stage drop-the-losers multi-arm
...
#' des <- des_dtl_pois()
#' @seealso \code{\link{build_dtl_pois}}, \code{\link{gui}},
