...
#' @export
build_gs_bern <- function(n10 = 77, n1 = n10*(1 + K*ratio), e = c(2.42, 2.42),
  ...
  if (summary) {
    #summary_build_gs_bern(n10, n1, e, f, K, alpha, beta, pi0, delta1, delta0,
