...
determination when utilising a variety of multiple comparison corrections (MCCs, including for $A$-, $D$-, and $E$-optimal designs), trial simulation,
...
fixed-sample multi-arm clinical trials. However, given the complexity of some of the supported MCCs, `an_ma()` and `an_ma_bern()` are included to help analyse the results from trials as well.
