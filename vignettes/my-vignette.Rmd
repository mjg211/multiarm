...
- __Holm-Bonferroni correction:__ This sets $\pi_k=\alpha/(K+1-k)$. It can be chosen by setting `correction = "holm_bonferroni"`.
- __Holm-Sidak correction:__ This sets $\pi_k = 1 - (1 - \alpha)^{1/(K+1-k)}$.
