...
Further details on single-stage design can be found in [Grayling and Wason (2020)](https://doi.org/10.1186/s12885-020-6525-0).
...
More detailed support, for single-stage designs, is available in the package vignette, which can be accessed with `vignette("single-stage", package = "multiarm")`.
...
In total, 31 functions are currently available.
