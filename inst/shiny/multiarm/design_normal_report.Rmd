---
title: "Fixed-sample multi-arm clinical trial design for a normally distributed primary outcome"
...
```{r, echo = F, results = "asis"}
library(knitr)
kable(params$data[, c(1:K, (2*K + 3):(4*K + 2))])
kable(params$data[, 1:(2*K + 2)])
kable(params$data[, -((K + 1):(4*K + 2))])
```
